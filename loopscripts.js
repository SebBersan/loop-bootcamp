...
/* //Loopa ut frukterna
let fruitsOne = ['apple', 'orange', 'pear', 'kiwi', 'pineapple'];
...
/* //Loopa ut frukterna med index
let fruitsTwo = ['apple', 'orange', 'pear', 'kiwi', 'pineapple'];

for(let i = 0; i < fruitsTwo.length; i++) {
    console.log(`${i}. ${fruitsTwo[i]}`)
}; */



/* // For of Loop
let thingsOne = ['hammer', 'nails', 'ruler', 'screwdriver', 'screws', 'saw'];

for (let thing of thingsOne) {
    console.log(thing);
} */


/* //For each Loops - skriv ut pryl
let thingsTwo = ['hammer', 'nails', 'ruler', 'screwdriver', 'screws', 'saw'];

thingsTwo.forEach(thing => {
    console.log(thing);
}); */


/* //For each Loops - skriv ut pryl + array position
...
/* // Loopa ut vänners favoritfruker
...
for (let i = 0; i < passwords.length; i++) {
  let bruteforce = passwords[i];

  if (bruteforce === topsecret) {
    console.log(`Aha! I found you, ${bruteforce}.`);
  }
}
